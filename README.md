...
> Nguyen T. Hung, Jianqi Huang, Yuki Tatsumi, Teng Yang, Riichiro Saito, QERaman: A open-source program for calculating resonance Raman spectroscopy based on Quantum ESPRESSO, https://arxiv.org/abs/xxxx
