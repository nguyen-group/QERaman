...
# Requirement
QERaman requires Quantum ESPRESSO version >= 7.1
...
> N. T. Hung, J. Huang, Y. Tatsumi, T. Yang and R. Saito, QERaman: A open-source program for calculating resonance Raman spectroscopy based on Quantum ESPRESSO, *Computer Physics Communications* in-press https://doi.org/10.1016/j.cpc.2023.108967
